...
void neutral_FEM() {
  set_Target(A_FEM, default_A_FEM);
  set_Target(B_FEM, default_B_FEM);
  set_Target(C_FEM, default_C_FEM);
  set_Target(D_FEM, default_D_FEM);
  set_Target(E_FEM, default_E_FEM);
  set_Target(F_FEM, default_F_FEM);
}
